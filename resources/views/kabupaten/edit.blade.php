            ...
            <div class="mb-3 card">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <form action="{{ route('kabupaten.update', $kabupaten->id) }}" method="post" enctype="multipart/form-data"> 
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <div class="position-relative row form-group"><label class="col-sm-4 col-form-label" for="nama">Kabupaten</label>
                                                <div class="col-sm-8"><input placeholder="Masukan Nama Kabupaten" type="text" name="nama" value="{{ $kabupaten->nama }}" class="form-control">
                                                    </div>
                                            </div>
                                            <div class="position-relative row form-group"><label class="col-sm-4 col-form-label" for="nama">Latitude</label>
                                                <div class="col-sm-8"><input placeholder="Masukan Latitude" type="text" name="lat" id="lat" value="{{ $kabupaten->lat }}" class="form-control">
                                                    </div>
                                            </div>
                                            <div class="position-relative row form-group"><label class="col-sm-4 col-form-label" for="nama">Longitude</label>
                                                <div class="col-sm-8"><input placeholder="Masukan Longitude" type="text" name="long" id="long" value="{{ $kabupaten->long }}" class="form-control">
                                                    </div>
                                            </div>
